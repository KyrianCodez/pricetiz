...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=861204000ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="563">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oswa&table=media">`oswa`.`media`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oswa&table=products">`oswa`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oswa&table=users">`oswa`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oswa&table=notifications">`oswa`.`notifications`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mrltd_laravel&table=categories">`mrltd_laravel`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mrltd_laravel&table=products">`mrltd_laravel`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mrltd_laravel&table=media">`mrltd_laravel`.`media`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mrltd_laravel&table=testimonials">`mrltd_laravel`.`testimonials`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mrltd_laravel&table=services">`mrltd_laravel`.`services`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mrltd_laravel&table=sessions">`mrltd_laravel`.`sessions`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2826335c5623447a5e55702d68534223">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="563"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mrltd_laravel" targettable="categories">
...
(3, &#039;Default User&#039;, &#039;user&#039;, &#039;12dea96fec20593566ab75692c9949596833adc9&#039;, 3, &#039;no_image.jpg&#039;, 1, &#039;2015-09-27 22:00:15&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="oswa" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="oswa" targettable="notifications">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `notifications`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="oswa" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="oswa" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE IF NOT EXISTS `myinstance_asset_model_relations`
( `id` INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
  ...
  FOREIGN KEY (`target`)
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE
) ENGINE InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="oswa" targettable="media">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `media`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="oswa" targettable="media">
                            <div class="action_content">
