    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-box clearfix">
                ...
                <div class="panel-value pull-right">
                    <h2 class="margin-top"> <?php  echo $dailyVisits ?></h2>
                    <p class="text-muted">Daily Visits</p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-box clearfix">
                ...
                <div class="panel-value pull-right">
                    <h2 class="margin-top"> <?php echo $dailyVisitors?></h2>
        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="jumbotron text-center">
                    ...
                    <p> <strong>Pricetize</strong> is here for <strong> you. </strong>.
                        <br>If you have a question regarding the usage of this website, please ask on our Pricetize
                        <a href="https://www.facebook.com/PriceTize-103100381461952/" title="Facebook"
