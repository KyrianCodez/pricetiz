                            ...
                            <table class="table table-bordered" id="productTable">
                                ...
                                <tbody id="product-table-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if($product["website"] === null) :?>
                                            No Link
                                            <?php else: ?>
                                            <i class="fas fa-external-link-alt link"></i>
                                            <a target='_blank' href="<?php echo  $product['website']; ?>">Link</a>
                                            <?php endif; ?>
                                        </td>
                        ...
                        tableColumns.forEach((tCol, i) => {
                            ...
                            if (productCol) {
                                if (productCol === "itemLink") {
                                    ...
                                    "reviewLink") {
                                    row +=
                                        `<td> <?php if($product["reviewLink"] === null) :?>
                           No Link

                            <?php else: ?><i class="rlink fab fa-youtube "> </i> <a target = '_blank' href="${p[productColumns.findIndex((c) => c === productCol)]}">Link</a> <?php endif; ?> </td>`;
                                        ...
                                        for (let tCol of tableColumns) {
                                            ...
                                            if (pCol) {
                                                console.log(p[productColumns.findIndex((c) => c ===
                                                    pCol)]);
                                                let matches = (p[productColumns.findIndex((c) => c ===
                                                        pCol)] || "")
