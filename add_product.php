               ...
               <div class="row">
                 ...
                 <div class="col-md-4">
                   <div class="input-group">
                     ...
                     <input type="number" step="0.01" min="0" class="form-control" name="buying-price" placeholder="Buying Price">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="number" step="0.01" min="0" class="form-control" name="saleing-price" placeholder="Selling Price">
                      <!-- <span class="input-group-addon">.00</span> -->
                   </div>
                  </div>
               </div>    
